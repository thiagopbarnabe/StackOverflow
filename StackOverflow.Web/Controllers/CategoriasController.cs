...
namespace StackOverflow.Web.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(StackOverflowContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,Titulo,Descricao")] Categoria categoria)
        {
